...
server.post('/hrithik' ,[
    body('username').notEmpty().isAlpha().withMessage('Username should be in alphabets and should not be empty'),
    body('usermail').isEmail().withMessage('Please enter a valid email address'),
    // body('userpass').isInt({min: 8}).withMessage('Password should be at least 8 characters long')
], (req, res)=>{ 
